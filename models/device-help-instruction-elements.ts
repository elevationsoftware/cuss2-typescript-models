 ...
 *
 * @export
 * @interface DeviceHelpInstructionElements
 */
export interface DeviceHelpInstructionElements {

    /**
     * Estimated announcement time in seconds
     *
     * @type {number}
     * @memberof DeviceHelpInstructionElements
     */
    time?: number;

    /**
     * XML formatted device help text structure to be passed to applications for audio output. The texts for the audio output need to be in SSML 1.0/SSML 1.1 format.<p>   <b>Example:</b>   ```XML       <speak version=\"1.0\" xmlns=\"http://www.w3.org/2001/10/synthesis\" xml:lang=\"en-US\">         The magnetic card reader device is used to read the data from your credit card or frequent flyer card       </speak>       or...       <speak version=\"1.0\" xmlns=\"http://www.w3.org/2001/10/synthesis\" xml:lang=\"ja-JP\">         磁気カードリーダ装置は、クレジットカードやマイレージカードからデータを読 み取るために使用される       </speak>       or ... 
     *
     * @type {string}
     * @memberof DeviceHelpInstructionElements
     */
