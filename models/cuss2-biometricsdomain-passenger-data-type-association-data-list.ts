...
import { CUSS2BiometricsDomainAssociationDataItemType } from './cuss2-biometrics-domain-association-data-item-type';
 /**
 * Passenger attribute association data managed by the client.
 *
 * @export
 * @interface CUSS2BiometricsdomainPassengerDataTypeAssociationDataList
 */
export interface CUSS2BiometricsdomainPassengerDataTypeAssociationDataList {

    /**
     * Individual association data item, exclusively maintained by and meaningful only to the client.
     *
     * @type {Array<CUSS2BiometricsDomainAssociationDataItemType>}
     * @memberof CUSS2BiometricsdomainPassengerDataTypeAssociationDataList
     */
    associationDataItem?: Array<CUSS2BiometricsDomainAssociationDataItemType>;
}
