...
import { CUSS2BiometricsDomainGPDataItemType } from './cuss2-biometrics-domain-gpdata-item-type';
 /**
 * Passenger attribute association data managed by the client.
 *
 * @export
 * @interface CUSS2BiometricsDomainGPDataListType
 */
export interface CUSS2BiometricsDomainGPDataListType {

    /**
     * Individual association data item, exclusively maintained by and meaningful only to the client.
     *
     * @type {Array<CUSS2BiometricsDomainGPDataItemType>}
     * @memberof CUSS2BiometricsDomainGPDataListType
     */
    gpDataItems: Array<CUSS2BiometricsDomainGPDataItemType>;
}
