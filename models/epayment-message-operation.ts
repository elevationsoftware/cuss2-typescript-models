...
import { OperationDocumentType } from './operation-document-type';
 /**
 ...
 *
 * @export
 * @interface EPaymentMessageOperation
 */
export interface EPaymentMessageOperation {

    /**
     * @type {OperationDocumentType}
     * @memberof EPaymentMessageOperation
     */
     ...
     * @memberof EPaymentMessageOperation
     */
    operationType: EPaymentMessageOperationOperationTypeEnum;
     ...
     * @memberof EPaymentMessageOperation
     */
    operationResponse?: EPaymentMessageOperationOperationResponseEnum;
}
 ...
 * @enum {string}
 */
export enum EPaymentMessageOperationOperationTypeEnum {
 ...
 * @enum {string}
 */
export enum EPaymentMessageOperationOperationResponseEnum {
    OFFLINE = 'OFFLINE',
    ONLINE = 'ONLINE',
    COMPLETED = 'COMPLETED',
