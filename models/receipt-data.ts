 ...
 */
 ...
 /**
 * Acquirer-provided pre-formatted receipt data. This element provides pre-formatted receipt data that is the application’s responsibility to process  as required. It is an application business logic decision, and potentially a bank certification requirement, to properly format and process this data  on a receipt for the customer.
 *
 * @export
