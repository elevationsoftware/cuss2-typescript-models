...
import { EPaymentMessageTransactionTransactionResponseApproval } from './epayment-message-transaction-transaction-response-approval';
import { EPaymentMessageTransactionTransactionResponseNonApproval } from './epayment-message-transaction-transaction-response-non-approval';
import { TransactionStatus } from './transaction-status';
 /**
 * Financial request response from payment component to common use application.
 *
 * @export
 * @interface EPaymentMessageTransactionTransactionResponse
 */
export interface EPaymentMessageTransactionTransactionResponse {

    /**
     * @type {string}
     * @memberof EPaymentMessageTransactionTransactionResponse
     */
    responseType: EPaymentMessageTransactionTransactionResponseResponseTypeEnum;

    /**
     * @type {EPaymentMessageTransactionTransactionResponseApproval}
     * @memberof EPaymentMessageTransactionTransactionResponse
     */
    approval?: EPaymentMessageTransactionTransactionResponseApproval;

    /**
     * @type {EPaymentMessageTransactionTransactionResponseNonApproval}
     * @memberof EPaymentMessageTransactionTransactionResponse
     */
 ...
 * @enum {string}
 */
export enum EPaymentMessageTransactionTransactionResponseResponseTypeEnum {
    APPROVAL = 'APPROVAL',
