...
import { ApplicationStateChangeReasonCodes } from './application-state-change-reason-codes';
import { ApplicationStateCodes } from './application-state-codes';
 /**
...
export interface ApplicationState {
    ...
    /**
     * @type {ApplicationStateChangeReasonCodes}
     * @memberof ApplicationState
     */
