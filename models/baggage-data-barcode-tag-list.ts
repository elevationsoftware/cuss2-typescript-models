...
import { BarcodeTagDataType } from './barcode-tag-data-type';
 /**
 * List of optical barcode measurement values.
 *
 * @export
 * @interface BaggageDataBarcodeTagList
 */
export interface BaggageDataBarcodeTagList {

    /**
     * @type {Array<BarcodeTagDataType>}
     * @memberof BaggageDataBarcodeTagList
     */
