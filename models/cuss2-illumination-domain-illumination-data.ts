...
import { CUSS2IlluminationDomainBlinkingRateType } from './cuss2-illumination-domain-blinking-rate-type';
import { CUSS2IlluminationdomainIlluminationDataLightColor } from './cuss2-illuminationdomain-illumination-data-light-color';
 /**
 * Definition for light controls.
 *
 * @export
 * @interface CUSS2IlluminationDomainIlluminationData
 */
export interface CUSS2IlluminationDomainIlluminationData {
     ...
     *
     * @type {number}
     * @memberof CUSS2IlluminationDomainIlluminationData
     */
    duration: number;

    /**
     * @type {CUSS2IlluminationdomainIlluminationDataLightColor}
     * @memberof CUSS2IlluminationDomainIlluminationData
     */
    lightColor: CUSS2IlluminationdomainIlluminationDataLightColor;

    /**
     * @type {CUSS2IlluminationDomainBlinkingRateType}
     * @memberof CUSS2IlluminationDomainIlluminationData
     */
    blinkRate?: CUSS2IlluminationDomainBlinkingRateType;
}
