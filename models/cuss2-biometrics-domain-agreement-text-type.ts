 ...
 *
 * @export
 * @interface CUSS2BiometricsDomainAgreementTextType
 */
export interface CUSS2BiometricsDomainAgreementTextType {

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainAgreementTextType
     */
