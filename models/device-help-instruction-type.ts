...
import { DeviceHelpInstructionElements } from './device-help-instruction-elements';
 /**
 * XML formatted device help text structure to be inserted into applications audio output.
 *
 * @export
 * @interface DeviceHelpInstructionType
 */
export interface DeviceHelpInstructionType {
     ...
     *
     * @type {Array<DeviceHelpInstructionElements>}
     * @memberof DeviceHelpInstructionType
     */
