...
import { CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment } from './common-use-payment-message-characteristics-characteristics-response-epayment';
 /**
 * 
 *
 * @export
 * @interface CommonUsePaymentMessageCharacteristicsCharacteristicsResponse
 */
export interface CommonUsePaymentMessageCharacteristicsCharacteristicsResponse {

    /**
     * @type {CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment}
     * @memberof CommonUsePaymentMessageCharacteristicsCharacteristicsResponse
     */
