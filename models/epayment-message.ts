...
import { EPaymentMessageOperation } from './epayment-message-operation';
import { EPaymentMessageSetup } from './epayment-message-setup';
import { EPaymentMessageTransaction } from './epayment-message-transaction';
 /**
 * Common use payment component request/response message.
 *
 * @export
 * @interface EPaymentMessage
 */
export interface EPaymentMessage {

    /**
     * @type {string}
     * @memberof EPaymentMessage
     */
    ePaymentMsgType: EPaymentMessageEPaymentMsgTypeEnum;

    /**
     * @type {EPaymentMessageSetup}
     * @memberof EPaymentMessage
     */
    setup?: EPaymentMessageSetup;

    /**
     * @type {EPaymentMessageTransaction}
     * @memberof EPaymentMessage
     */
    transaction?: EPaymentMessageTransaction;

    /**
     * @type {EPaymentMessageOperation}
     * @memberof EPaymentMessage
     */
 ...
 * @enum {string}
 */
export enum EPaymentMessageEPaymentMsgTypeEnum {
    OPERATION = 'OPERATION',
    SETUP = 'SETUP',
