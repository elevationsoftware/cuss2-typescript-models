...
import { CUSS2BiometricsDomainAgreementTextType } from './cuss2-biometrics-domain-agreement-text-type';
 /**
 * List of agreements/consents to present prior to or during enrollment.
 *
 * @export
 * @interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestAgreementsList
 */
export interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestAgreementsList {

    /**
     * @type {Array<CUSS2BiometricsDomainAgreementTextType>}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestAgreementsList
     */
    agreementTextList: Array<CUSS2BiometricsDomainAgreementTextType>;
}
