...
import { CUSS2BiometricsDomainBiometricProviderMessageType } from './cuss2-biometrics-domain-biometric-provider-message-type';
import { CUSS2BiometricsdomainBiometricProviderMessageBiometricRequest } from './cuss2-biometricsdomain-biometric-provider-message-biometric-request';
import { CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestData } from './cuss2-biometricsdomain-biometric-provider-message-biometric-request-data';
import { CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse } from './cuss2-biometricsdomain-biometric-provider-message-biometric-response';
 /**
 * Common use biometric provider component request/response message.
 *
 * @export
 * @interface CUSS2BiometricsDomainBiometricProviderMessage
 */
export interface CUSS2BiometricsDomainBiometricProviderMessage {

    /**
     * @type {CUSS2BiometricsDomainBiometricProviderMessageType}
     * @memberof CUSS2BiometricsDomainBiometricProviderMessage
     */
    biometricProviderMessageType: CUSS2BiometricsDomainBiometricProviderMessageType;

    /**
     * @type {CUSS2BiometricsDomainBiometricProviderMessageType}
     * @memberof CUSS2BiometricsDomainBiometricProviderMessage
     */
    biometricProviderMessageReturnType: CUSS2BiometricsDomainBiometricProviderMessageType;
     ...
     * @memberof CUSS2BiometricsDomainBiometricProviderMessage
     */
    biometricFunctionType: CUSS2BiometricsDomainBiometricProviderMessageBiometricFunctionTypeEnum;

    /**
     * @type {CUSS2BiometricsdomainBiometricProviderMessageBiometricRequest}
     * @memberof CUSS2BiometricsDomainBiometricProviderMessage
     */
    biometricRequest?: CUSS2BiometricsdomainBiometricProviderMessageBiometricRequest;

    /**
     * @type {CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestData}
     * @memberof CUSS2BiometricsDomainBiometricProviderMessage
     */
    biometricRequestData?: CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestData;

    /**
     * @type {CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse}
     * @memberof CUSS2BiometricsDomainBiometricProviderMessage
     */
    biometricResponse?: CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse;
}
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainBiometricProviderMessageBiometricFunctionTypeEnum {
    ASSOCIATE = 'ASSOCIATE',
