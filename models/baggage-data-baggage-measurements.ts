...
import { ExtendedWeightType } from './extended-weight-type';
 /**
 * Values identified for an object on the measurement device.
 *
 * @export
 * @interface BaggageDataBaggageMeasurements
 */
export interface BaggageDataBaggageMeasurements {

    /**
     * @type {ExtendedWeightType}
     * @memberof BaggageDataBaggageMeasurements
     */
