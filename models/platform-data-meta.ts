...
import { PassengerSessionID } from './passenger-session-id';
import { PlatformDataMetaEventClassification } from './platform-data-meta-event-classification';
import { PlatformDirectives } from './platform-directives';
import { UniqueID } from './unique-id';
 /**
 * The META data of this message
 *
 * @export
 * @interface PlatformDataMeta
 */
export interface PlatformDataMeta {

    /**
     * @type {UniqueID}
     * @memberof PlatformDataMeta
     */
    deviceID: UniqueID;
    ...
    /**
     * @type {PlatformDataMetaEventClassification}
     * @memberof PlatformDataMeta
     */
    eventClassification?: PlatformDataMetaEventClassification;

    /**
     * @type {PlatformDirectives}
     * @memberof PlatformDataMeta
     */
