 ...
 *
 * @export
 * @interface CommonUsePaymentMessageErrorResponse
 */
export interface CommonUsePaymentMessageErrorResponse {
     ...
     *
     * @type {string}
     * @memberof CommonUsePaymentMessageErrorResponse
     */
     ...
     * @memberof CommonUsePaymentMessageErrorResponse
     */
    errorReason: CommonUsePaymentMessageErrorResponseErrorReasonEnum;
 ...
 * @enum {string}
 */
export enum CommonUsePaymentMessageErrorResponseErrorReasonEnum {
