 ...
 *
 * @export
 * @interface CUSS2BiometricsDomainAssociationDataItemType
 */
export interface CUSS2BiometricsDomainAssociationDataItemType {

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainAssociationDataItemType
     */
    data?: string;
