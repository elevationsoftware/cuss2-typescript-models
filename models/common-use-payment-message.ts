...
import { CommonUsePaymentMessageCharacteristics } from './common-use-payment-message-characteristics';
import { CommonUsePaymentMessageErrorResponse } from './common-use-payment-message-error-response';
import { EPaymentMessage } from './epayment-message';
 /**
 * Common use message document root element.
 *
 * @export
 * @interface CommonUsePaymentMessage
 */
export interface CommonUsePaymentMessage {
     ...
     *
     * @type {string}
     * @memberof CommonUsePaymentMessage
     */
    sessionID?: string;
     ...
     * @memberof CommonUsePaymentMessage
     */
    documentType: CommonUsePaymentMessageDocumentTypeEnum;

    /**
     * @type {CommonUsePaymentMessageCharacteristics}
     * @memberof CommonUsePaymentMessage
     */
    characteristics?: CommonUsePaymentMessageCharacteristics;

    /**
     * @type {EPaymentMessage}
     * @memberof CommonUsePaymentMessage
     */
    ePaymentMessage?: EPaymentMessage;

    /**
     * @type {CommonUsePaymentMessageErrorResponse}
     * @memberof CommonUsePaymentMessage
     */
 ...
 * @enum {string}
 */
export enum CommonUsePaymentMessageDocumentTypeEnum {
