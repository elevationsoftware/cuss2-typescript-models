...
import { CardBrandList } from './card-brand-list';
import { CurrencyCodeList } from './currency-code-list';
import { FeatureList } from './feature-list';
import { MediaTypeList } from './media-type-list';
 /**
 * ePayment component characteristics.
 *
 * @export
 * @interface CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment
 */
export interface CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment {

    /**
     * @type {FeatureList}
     * @memberof CommonUsePaymentMessageCharacteristicsCharacteristicsResponseEPayment
     */
