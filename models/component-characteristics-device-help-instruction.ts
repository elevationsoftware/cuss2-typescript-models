...
import { DeviceHelpInstructionType } from './device-help-instruction-type';
 /**
 * 
 *
 * @export
 * @interface ComponentCharacteristicsDeviceHelpInstruction
 */
export interface ComponentCharacteristicsDeviceHelpInstruction {

    /**
     * @type {DeviceHelpInstructionType}
     * @memberof ComponentCharacteristicsDeviceHelpInstruction
     */
