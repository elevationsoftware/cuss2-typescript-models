...
import { CUSS2IlluminationDomainRgbType } from './cuss2-illumination-domain-rgb-type';
 /**
 ...
 *
 * @export
 * @interface CUSS2IlluminationdomainIlluminationDataLightColor
 */
export interface CUSS2IlluminationdomainIlluminationDataLightColor {
     ...
     *
     * @type {string}
     * @memberof CUSS2IlluminationdomainIlluminationDataLightColor
     */
    name?: CUSS2IlluminationdomainIlluminationDataLightColorNameEnum;

    /**
     * @type {CUSS2IlluminationDomainRgbType}
     * @memberof CUSS2IlluminationdomainIlluminationDataLightColor
     */
    rgb?: CUSS2IlluminationDomainRgbType;
}
 ...
 * @enum {string}
 */
export enum CUSS2IlluminationdomainIlluminationDataLightColorNameEnum {
    ON = 'CLR_ON',
    OFF = 'CLR_OFF',
    RED = 'CLR_RED',
    GREEN = 'CLR_GREEN',
