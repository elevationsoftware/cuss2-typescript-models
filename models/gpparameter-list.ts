 ...
 *
 * @export
 * @interface GPParameterList
 */
export interface GPParameterList {

    /**
     * Special or proprietary payment parameters that can be provided by the CUSS application when requesting the payment,  and/or returned by the payment subsystem upon conclusion of the transaction. These are optional values. This container  is included in the schema to allow certain legacy payment protocols to be migrated to use the new payment interface.  It also allows for flexibility for future payment industry requirements that may affect common use or airline payment.          
     *
     * @type {Array<GPParameter>}
     * @memberof GPParameterList
     */
