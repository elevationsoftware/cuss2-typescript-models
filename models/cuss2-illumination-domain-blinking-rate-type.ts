 ...
 *
 * @export
 * @interface CUSS2IlluminationDomainBlinkingRateType
 */
export interface CUSS2IlluminationDomainBlinkingRateType {

    /**
     * Time in milliseconds the light remains switched off.
     *
     * @type {number}
     * @memberof CUSS2IlluminationDomainBlinkingRateType
     */
    durationOff: number;
