...
export interface ApplicationActivation {
     ...
     *
     * @type {string}
     * @memberof ApplicationActivation
     */
    applicationBrand?: string;

    /**
     * Indicates the mode of execution.<p> *MAM:* Multi Application Mode <br> *DSAM:* Dedicated Single Application Mode 
     *
     * @type {string}
     * @memberof ApplicationActivation
     */
    executionMode: ApplicationActivationExecutionModeEnum;
 ...
 * @enum {string}
 */
export enum ApplicationActivationExecutionModeEnum {
    MAM = 'MAM',
    DSAM = 'DSAM'
}
