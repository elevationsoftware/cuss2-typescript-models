...
import { CUSS2BiometricsDomainBiometricProviderMessage } from './cuss2-biometrics-domain-biometric-provider-message';
import { CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics } from './cuss2-biometricsdomain-common-use-biometric-message-characteristics';
 /**
 * Common use message document root element.
 *
 * @export
 * @interface CUSS2BiometricsDomainCommonUseBiometricMessage
 */
export interface CUSS2BiometricsDomainCommonUseBiometricMessage {

    /**
     * The document type that is included in this message.
     *
     * @type {string}
     * @memberof CUSS2BiometricsDomainCommonUseBiometricMessage
     */
    documentType: CUSS2BiometricsDomainCommonUseBiometricMessageDocumentTypeEnum;
    ...
    /**
     * @type {CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics}
     * @memberof CUSS2BiometricsDomainCommonUseBiometricMessage
     */
    characteristics?: CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics;

    /**
     * @type {CUSS2BiometricsDomainBiometricProviderMessage}
     * @memberof CUSS2BiometricsDomainCommonUseBiometricMessage
     */
    biometricProviderMessage?: CUSS2BiometricsDomainBiometricProviderMessage;
     ...
     * @memberof CUSS2BiometricsDomainCommonUseBiometricMessage
     */
    errorResponse?: CUSS2BiometricsDomainCommonUseBiometricMessageErrorResponseEnum;
}
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainCommonUseBiometricMessageDocumentTypeEnum {
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainCommonUseBiometricMessageErrorResponseEnum {
