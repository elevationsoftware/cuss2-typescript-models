...
import { CUSS2BiometricsDomainMRZTrackType } from './cuss2-biometrics-domain-mrztrack-type';
 /**
 * MRZ data from passenger's government-issued travel, visa or residency document.
 *
 * @export
 * @interface CUSS2BiometricsdomainPassengerDataTypePassengerMRZData
 */
export interface CUSS2BiometricsdomainPassengerDataTypePassengerMRZData {

    /**
     * @type {Array<CUSS2BiometricsDomainMRZTrackType>}
     * @memberof CUSS2BiometricsdomainPassengerDataTypePassengerMRZData
     */
    mrzTrackData: Array<CUSS2BiometricsDomainMRZTrackType>;
}
