 ...
 *
 * @export
 * @interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestEnvironment
 */
export interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestEnvironment {

    /**
     * Whether to execute the biometric function in accessibility mode.
     *
     * @type {boolean}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestEnvironment
     */
