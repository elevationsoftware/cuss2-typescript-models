...
import { CUSS2BiometricsDomainPassengerBiometricsType } from './cuss2-biometrics-domain-passenger-biometrics-type';
 /**
 * List or container of all passenger biometric data sets.
 *
 * @export
 * @interface CUSS2BiometricsdomainPassengerDataTypePassengerBiometricsData
 */
export interface CUSS2BiometricsdomainPassengerDataTypePassengerBiometricsData {

    /**
     * @type {Array<CUSS2BiometricsDomainPassengerBiometricsType>}
     * @memberof CUSS2BiometricsdomainPassengerDataTypePassengerBiometricsData
     */
    passengerBiometrics: Array<CUSS2BiometricsDomainPassengerBiometricsType>;
}
