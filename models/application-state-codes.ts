...
/**
 * Application state codes...<p> *UNAVAILABLE:* Application state change request to move to UNAVAILBLE <br>  *AVAILABLE:* Application state change request to move to AVAILBLE <br>  *ACTIVE:* Platform initiated or application state change request to move to ACTIVE <br>  *STOPPED:* Application state change request to move to STOPPED <br>  *RELOAD:* Application state change request to move to RELOAD <br>  *INITIALIZE:* Platform initiated application state <br> *SUSPENDED:* Platform initiated application state <br> *DISABLED:* Platform initiated application state 
 * @export
 * @enum {string}
 */
