...
import { EPaymentMessageTransactionTransactionAcknowledge } from './epayment-message-transaction-transaction-acknowledge';
import { EPaymentMessageTransactionTransactionRequest } from './epayment-message-transaction-transaction-request';
import { EPaymentMessageTransactionTransactionResponse } from './epayment-message-transaction-transaction-response';
import { TransactionDocumentType } from './transaction-document-type';
 /**
 * Financial transaction.
 *
 * @export
 * @interface EPaymentMessageTransaction
 */
export interface EPaymentMessageTransaction {

    /**
     * @type {TransactionDocumentType}
     * @memberof EPaymentMessageTransaction
     */
     ...
     * @memberof EPaymentMessageTransaction
     */
    transactionType: EPaymentMessageTransactionTransactionTypeEnum;

    /**
     * @type {EPaymentMessageTransactionTransactionRequest}
     * @memberof EPaymentMessageTransaction
     */
    transactionRequest?: EPaymentMessageTransactionTransactionRequest;

    /**
     * @type {EPaymentMessageTransactionTransactionResponse}
     * @memberof EPaymentMessageTransaction
     */
    transactionResponse?: EPaymentMessageTransactionTransactionResponse;

    /**
     * @type {EPaymentMessageTransactionTransactionAcknowledge}
     * @memberof EPaymentMessageTransaction
     */
 ...
 * @enum {string}
 */
export enum EPaymentMessageTransactionTransactionTypeEnum {
    CANCEL = 'CANCEL',
    PREAUTH = 'PRE_AUTH',
    POSTAUTH = 'POST_AUTH',
    PURCHASE = 'PURCHASE',
