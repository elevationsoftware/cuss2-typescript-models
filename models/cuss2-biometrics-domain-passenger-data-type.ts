...
import { CUSS2BiometricsDomainPassengerIDType } from './cuss2-biometrics-domain-passenger-idtype';
import { CUSS2BiometricsdomainPassengerDataTypeAssociationDataList } from './cuss2-biometricsdomain-passenger-data-type-association-data-list';
import { CUSS2BiometricsdomainPassengerDataTypePassengerBiometricsData } from './cuss2-biometricsdomain-passenger-data-type-passenger-biometrics-data';
import { CUSS2BiometricsdomainPassengerDataTypePassengerMRZData } from './cuss2-biometricsdomain-passenger-data-type-passenger-mrzdata';
 /**
 * Biometric function request passenger data.
 *
 * @export
 * @interface CUSS2BiometricsDomainPassengerDataType
 */
export interface CUSS2BiometricsDomainPassengerDataType {

    /**
     * Can be a maximum of 2 IDs (client and provider).
     *
     * @type {Array<CUSS2BiometricsDomainPassengerIDType>}
     * @memberof CUSS2BiometricsDomainPassengerDataType
     */
    passengerIDs?: Array<CUSS2BiometricsDomainPassengerIDType>;
    ...
    /**
     * @type {CUSS2BiometricsdomainPassengerDataTypePassengerMRZData}
     * @memberof CUSS2BiometricsDomainPassengerDataType
     */
    passengerMRZData?: CUSS2BiometricsdomainPassengerDataTypePassengerMRZData;

    /**
     * @type {CUSS2BiometricsdomainPassengerDataTypePassengerBiometricsData}
     * @memberof CUSS2BiometricsDomainPassengerDataType
     */
    passengerBiometricsData?: CUSS2BiometricsdomainPassengerDataTypePassengerBiometricsData;

    /**
     * @type {CUSS2BiometricsdomainPassengerDataTypeAssociationDataList}
     * @memberof CUSS2BiometricsDomainPassengerDataType
     */
    associationDataList?: CUSS2BiometricsdomainPassengerDataTypeAssociationDataList;
}
