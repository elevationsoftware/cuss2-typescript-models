 ...
 *
 * @export
 * @interface CUSS2BiometricsDomainPassengerIDType
 */
export interface CUSS2BiometricsDomainPassengerIDType {

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainPassengerIDType
     */
    identifier?: string;
     ...
     * @memberof CUSS2BiometricsDomainPassengerIDType
     */
    identifierType?: CUSS2BiometricsDomainPassengerIDTypeIdentifierTypeEnum;
}
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainPassengerIDTypeIdentifierTypeEnum {
    CLIENT = 'CLIENT',
    PROVIDER = 'PROVIDER'
}
