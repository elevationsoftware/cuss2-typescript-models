 ...
 *
 * @export
 * @interface CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReason
 */
export interface CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReason {

    /**
     * Eror code as received and mapped from the IMPs response.
     *
     * @type {string}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReason
     */
    failureCode: CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReasonFailureCodeEnum;
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReasonFailureCodeEnum {
    FAILED = 'FAILED',
    TIMEOUT = 'TIMEOUT',
