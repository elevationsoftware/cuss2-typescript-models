 ...
 *
 * @export
 * @interface CUSS2BiometricsDomainPassengerBiometricsType
 */
export interface CUSS2BiometricsDomainPassengerBiometricsType {

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainPassengerBiometricsType
     */
    data?: string;
     ...
     * @memberof CUSS2BiometricsDomainPassengerBiometricsType
     */
    biometricsType: CUSS2BiometricsDomainPassengerBiometricsTypeBiometricsTypeEnum;

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainPassengerBiometricsType
     */
    lightType?: CUSS2BiometricsDomainPassengerBiometricsTypeLightTypeEnum;

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainPassengerBiometricsType
     */
    dataSource?: CUSS2BiometricsDomainPassengerBiometricsTypeDataSourceEnum;

    /**
     * @type {string}
     * @memberof CUSS2BiometricsDomainPassengerBiometricsType
     */
    dataFormat: CUSS2BiometricsDomainPassengerBiometricsTypeDataFormatEnum;
}
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainPassengerBiometricsTypeBiometricsTypeEnum {
    FACE = 'FACE',
    FINGER = 'FINGER',
    IRIS = 'IRIS',
    PALM = 'PALM'
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainPassengerBiometricsTypeLightTypeEnum {
    IR = 'IR',
    UV = 'UV',
    VISIBLE = 'VISIBLE'
}
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainPassengerBiometricsTypeDataSourceEnum {
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsDomainPassengerBiometricsTypeDataFormatEnum {
    BMP = 'BMP',
    JPG = 'JPG',
    PNG = 'PNG'
}
