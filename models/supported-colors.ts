...
/**
 * Color capability definitions for illumination devices...<p> *CLR_RGB:* Illumination device supports colors in nearly the RGB spectrum <br> *CLR_ON:* Illumination device supports color for switched on mode <br> *CLR_OFF:* Illumination device supports color for switched off mode <br> *CLR_RED...CLR_WHITE:* Illumination device supports the specified color 
 * @export
 * @enum {string}
 */
