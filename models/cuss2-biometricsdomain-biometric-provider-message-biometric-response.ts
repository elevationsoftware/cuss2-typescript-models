...
import { CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReason } from './cuss2-biometricsdomain-biometric-provider-message-biometric-response-failure-reason';
 /**
 * Function request response from biometric provider component to common use application.
 *
 * @export
 * @interface CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse
 */
export interface CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse {

    /**
     * @type {string}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse
     */
    responseType: CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseResponseTypeEnum;

    /**
     * @type {CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReason}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse
     */
    failureReason?: CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseFailureReason;

    /**
     * @type {CUSS2BiometricsDomainPassengerDataType}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricResponse
     */
    passengerData?: CUSS2BiometricsDomainPassengerDataType;
 ...
 * @enum {string}
 */
export enum CUSS2BiometricsdomainBiometricProviderMessageBiometricResponseResponseTypeEnum {
