...
import { CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestDataProcessing } from './cuss2-biometricsdomain-biometric-provider-message-biometric-request-data-processing';
 /**
 ...
 *
 * @export
 * @interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestData
 */
export interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestData {

    /**
     * @type {CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestDataProcessing}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestData
     */
    processing?: CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestDataProcessing;
