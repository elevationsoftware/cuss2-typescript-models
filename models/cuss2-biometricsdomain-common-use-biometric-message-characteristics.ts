...
import { CUSS2BiometricsDomainBiometricAnyType } from './cuss2-biometrics-domain-biometric-any-type';
import { CUSS2BiometricsDomainCharacteristicsDocumentType } from './cuss2-biometrics-domain-characteristics-document-type';
 /**
 * Component characteristics.
 *
 * @export
 * @interface CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics
 */
export interface CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics {

    /**
     * @type {CUSS2BiometricsDomainCharacteristicsDocumentType}
     * @memberof CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics
     */
    characteristicsDocumentType: CUSS2BiometricsDomainCharacteristicsDocumentType;

    /**
     * @type {CUSS2BiometricsDomainCharacteristicsDocumentType}
     * @memberof CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics
     */
    characteristicsDocumentReturnType: CUSS2BiometricsDomainCharacteristicsDocumentType;

    /**
     * @type {CUSS2BiometricsDomainBiometricAnyType}
     * @memberof CUSS2BiometricsdomainCommonUseBiometricMessageCharacteristics
     */
    characteristicsRequest?: CUSS2BiometricsDomainBiometricAnyType;
}
