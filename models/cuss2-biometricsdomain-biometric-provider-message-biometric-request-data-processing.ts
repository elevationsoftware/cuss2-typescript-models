 ...
 *
 * @export
 * @interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestDataProcessing
 */
export interface CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestDataProcessing {
     ...
     *
     * @type {Array<string>}
     * @memberof CUSS2BiometricsdomainBiometricProviderMessageBiometricRequestDataProcessing
     */
